...
var EBMLMetaDataRefiner = (function () {
        ...
        elms.forEach(function (elm) {
            ...
            if (elm.type === "m" && elm.name === "Cluster") {
                if (!_this.reachFirstCluster) {
                    ...
                    _this.clusterStartPos = elm.start;
    ...
    EBMLMetaDataRefiner.prototype.putRefinedMetaData = function () {
        var _this = this;
        var clusterStartPos = this.clusterStartPos;
        var fstSgm = this.segments[0];
        if (fstSgm == null) {
            return { metadata: new ArrayBuffer(0), clusterStartPos: clusterStartPos };
        } // まだ Segment まで読んでない
        ...
        var metadata = create(totalByte - metadataSize);
