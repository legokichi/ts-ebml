...
else if (commander_1.default.keyframe) {
    var decoder_1 = new _1.Decoder();
    var TrackType_1 = -1;
    var TrackNumber_1 = -1;
    var CodecID_1 = "";
    var trackTypes_1 = {};
    fs_1.default.createReadStream(args[0]).on('data', function (buf) {
