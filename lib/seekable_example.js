...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("../ok.webm")];
                case 1:
                    res = _a.sent();
                    return [4 /*yield*/, res.arrayBuffer()];
                case 2:
                    buf = _a.sent();
                    elms = new EBML.Decoder().decode(buf);
                    ...
                    elms.forEach(function (elm) { return reader.read(elm); });
                    console.log("ajgjgiorwajio");
                    metadataElms = new EBML.Decoder().decode(metadataBuf);
                    console.log(metadataElms, clusterPtrs, last_duration, metadataBuf);
                    ...
                    refinedElms.forEach(function (elm) { return _reader.read(elm); });
                    return [2 /*return*/];
            }
        });
    });
...
function _() {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        var decoder, encoder, reader, tasks, metadataBuf, webM, last_duration, clusterPtrs, stream, rec, metadataElms, refinedElms, refinedMetadataBuf, webMBuf, body, refinedWebM, raw_video, refined_video, refinedWebMBuf, elms, _reader;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    ...
                    document.body.appendChild(document.createTextNode("media-recorder-original(not seekable)"));
                    ...
                    document.body.appendChild(document.createElement("br"));
                    document.body.appendChild(document.createTextNode("add-seekhead-and-duration(seekable)"));
                    document.body.appendChild(document.createElement("br"));
                ...
                case 4:
                    ...
                    elms = new EBML.Decoder().decode(refinedWebMBuf);
                    _reader = new EBMLReader_1.default();
                    _reader.logging = true;
                    elms.forEach(function (elm) { return _reader.read(elm); });
                    _reader.stop();
                    return [2 /*return*/];
            }
        });
