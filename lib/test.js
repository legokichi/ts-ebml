            ...
            case 2:
                ...
                tests = [
                    ...
                    { index: 28, test: function (elm) {
                            ...
                            assert.ok(elm.type === "d" && _2.tools.convertEBMLDateToJSDate(elm.value).getTime() === new Date("2010-08-21T07:23:03.000Z").getTime()); // toISOString
                        } },
                    { index: 29, test: function (elm) {
                            assert.ok(elm.name === "SegmentUID" && elm.type === "b");
                            if (elm.type === "b") {
                                var buf_1 = new Uint8Array(new Buffer([0x92, 0x2d, 0x19, 0x32, 0x0f, 0x1e, 0x13, 0xc5, 0xb5, 0x05, 0x63, 0x0a, 0xaf, 0xd8, 0x53, 0x36]));
            ...
            switch (_a.label) {
                case 0:
                    ...
                    reader.addListener("cluster", function (ev) {
                        ...
                        var assertion = data.every(function (elm) { return elm.name === "Cluster" || elm.name === "Timecode" || elm.name === "SimpleBlock"; });
