...
var _1 = require("./");
var EBMLMetaDataRefiner_1 = require("./EBMLMetaDataRefiner");
var Buffer = require("buffer/").Buffer;
var decoder = new _1.Decoder();
var encoder = new _1.Encoder();
var refiner = new EBMLMetaDataRefiner_1.default();
function recorder_main() {
    return __awaiter(this, void 0, void 0, function () {
        var stream, rec, tasks, WebM, _a, metadata, clusterStartPos, webmBuf, clustersBuf, refined, originalVid, refinedVid;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    rec.ondataavailable = function (ev) {
                        ...
                        var task = readAsArrayBuffer(chunk)
                            ...
                            var WebPs = _1.tools.WebPFrameFilter(chunks);
                            refiner.read(chunks);
                            var prms = WebPs
                ...
                case 3:
                    _b.sent();
                    _a = refiner.putRefinedMetaData(), metadata = _a.metadata, clusterStartPos = _a.clusterStartPos;
                    return [4 /*yield*/, readAsArrayBuffer(WebM)];
                case 4:
                    webmBuf = _b.sent();
                    clustersBuf = webmBuf.slice(clusterStartPos);
                    refined = new Blob([metadata, clustersBuf], { type: "video/webm" });
                    return [4 /*yield*/, putVideo(WebM, "plain recorded webm")];
                case 5:
                    originalVid = _b.sent();
                ...
                case 6:
                    ...
                    originalVid.onseeked = function () {
                        originalVid.onseeked = undefined;
...
function serv_main() {
    return __awaiter(this, void 0, void 0, function () {
        var res, webmBuf, elms, _a, metadata, clusterStartPos, clustersBuf, original, refined, refinedBuf, redinedElms, originalVid, refinedVid;
        return __generator(this, function (_b) {
            switch (_b.label) {
...
function writer_main() {
    ...
    var binarized = tagStream.map(_1.tools.encodeValueToBuffer);
...
function fetchImage(src) {
    return new Promise(function (resolve, reject) {
        ...
        img.onerror = function (err) { reject(err.error); };
    });
}
