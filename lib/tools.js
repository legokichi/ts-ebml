...
function readBlock(buf) {
    return ebmlBlock(new exports.Buffer(buf));
}
...
function VP8BitStreamToRiffWebPBuffer(frame) {
    var VP8Chunk = createRIFFChunk("VP8 ", new exports.Buffer(frame));
    var WebPChunk = exports.Buffer.concat([
        new exports.Buffer("WEBP", "ascii"),
        new exports.Buffer(VP8Chunk)
    ]);
...
function createRIFFChunk(FourCC, chunk) {
    ...
    return exports.Buffer.concat([
        new exports.Buffer(FourCC.substr(0, 4), "ascii"),
        chunkSize,
        new exports.Buffer(chunk),
